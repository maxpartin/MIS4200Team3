...
{
    public class RegisterSecondaryController : Controller
    {
        private RegisterContext db = new RegisterContext();

        // GET: RegisterSecondary
        public ActionResult Index()
        {
            return View(db.RegisterSecondary.ToList());
        }

        // GET: RegisterSecondary/Details/5
        ...
        // GET: RegisterSecondary/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: RegisterSecondary/Create
        ...
        // GET: RegisterSecondary/Delete/5
        ...
        // POST: RegisterSecondary/Delete/5
